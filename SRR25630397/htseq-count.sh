...
#SBATCH --job-name=htseq-count_SRR25630397            #optional: job name
...
/usr/bin/time -v htseq-count -s yes -i gene_id\
  /projects/bgmp/ica/bioinfo/Bi623/PS2/QAA/SRR25630397/Crh_rhy107_EO_adult.out.sorted.rmdup.sam \
  /projects/bgmp/ica/bioinfo/Bi623/PS2/QAA/SRR25630397/campylomormyrus.gtf \
  > /projects/bgmp/ica/bioinfo/Bi623/PS2/QAA/SRR25630397/Crh_rhy107_EO_adult.htseq.stranded_yes.txt

/usr/bin/time -v htseq-count -s reverse -i gene_id\
  /projects/bgmp/ica/bioinfo/Bi623/PS2/QAA/SRR25630397/Crh_rhy107_EO_adult.out.sorted.rmdup.sam \
  /projects/bgmp/ica/bioinfo/Bi623/PS2/QAA/SRR25630397/campylomormyrus.gtf \
  > /projects/bgmp/ica/bioinfo/Bi623/PS2/QAA/SRR25630397/Crh_rhy107_EO_adult.htseq.stranded_reverse.txt