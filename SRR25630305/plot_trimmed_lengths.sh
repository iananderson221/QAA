...
#SBATCH --job-name=plot_trimmed_reads_SRR25630305            #optional: job name
...
/usr/bin/time -v ./plot_trimmed_lengths.py \
  --sample Cco_com125_EO_6cm \
  --r1 /projects/bgmp/ica/bioinfo/Bi623/PS2/QAA/SRR25630305/Cco_com125_EO_6cm_1.trim.paired.fastq.gz \
  --r2 /projects/bgmp/ica/bioinfo/Bi623/PS2/QAA/SRR25630305/Cco_com125_EO_6cm_2.trim.paired.fastq.gz
